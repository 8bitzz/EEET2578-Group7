...
public class CM_LocationServer_IntegrationTest {
    ...
    public void testLocationSuggestion1(){
        final String[] locationWithRestaurant= {"Vivo City Shopping Centre", "Crescent Mall","Dam Sen Parklands","Ho Chi Minh City, Downtown"};
    ...
    public void testLocationSuggestion3(){
        final String[] locationWithPool= {"Vivo City Shopping Centre","Dam Sen Parklands"};
        String service = "pool";
        List<LocationDetails> cityInfo = ContextManager.readCityInfo();
        List<String> locations = ContextManager.getLocationsByService(service);
        System.out.println(locations.size());
//
    ...
    public void testLocationSuggestion4(){
        final String[] locationWithShops= {"Vivo City Shopping Centre", "Crescent Mall","Dam Sen Parklands","Ho Chi Minh City, Downtown"};
...
//
    ...
    public void testLocationSuggestion5(){
        final String[] locationWithShops= {"Dam Sen Parklands"};
